  ...
  return (
    <>
     <div className="contact-nav"> <Navbar /></div>
      ...
      <div className="contact-bg-img3 text-center">
        <div className="map2">
        ...
        <br /><br />
        <img src={img4} className="img-email-box  " />
        <h4 className="email-address-contact-page text-center">info@freshproduce.co.in</h4>
      </div>
